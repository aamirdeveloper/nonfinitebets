...
import { FaChartLine, FaFacebook, FaGoogle, FaRegFutbol, FaTableTennis, FaTwitch, FaYoutube } from 'react-icons/fa'
                    ...
                    <div className="main-panel">
                        <div className="content-wrapper pt-0">
                            ...
                            <div className="padding pt-0">
                                <div className="dash-01" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/images/img1.png)` }}>
                                    <div className="overlay pb-0 pt-4 pt-md-3 px-0 px-md-4">
                                        <div className="row g-3 align-items-end">
                                            <div className="col-md-3 col-6 order-1 order-md-0">
                                                <img src={`${process.env.PUBLIC_URL}/images/team1.png`} alt="" className="img-fluid d-none d-md-flex mx-auto" />
                                                <img src={`${process.env.PUBLIC_URL}/images/team1-mob.png`} alt="" className="img-fluid d-flex d-md-none" />
                                            </div>
                                            <div className="col-md-6 col-12 align-self-center text-center">
                                                <h1 className="mb-4 fw-bold">Play Smarter</h1>
                                                <button className="btn btn1 mb-3" style={{ width: '220px' }} data-bs-toggle="modal" data-bs-target="#authModal" data-bs-tab="signup">Register Instantly</button>
                                                <div className="or mb-3" style={{ maxWidth: '150px' }}>
                                                    <p className="mb-0 fs-12" style={{ background: '#140d2e' }}>or</p>
                                                </div>
                                                <div className="social">
                                                    <a href="#" style={{ color: '#1877F2' }}><FaFacebook /></a>
                                                    <a href="#" style={{ color: '#9C40FF' }}><FaTwitch /></a>
                                                    <a href="#" style={{ color: '#FF3D00' }}><FaGoogle /></a>
                                                </div>
                                            </div>
                                            <div className="col-md-3 col-6 order-2 order-md-0">
                                                <img src={`${process.env.PUBLIC_URL}/images/team2.png`} alt="" className="img-fluid d-none d-md-flex mx-auto" />
                                                <img src={`${process.env.PUBLIC_URL}/images/team2-mob.png`} alt="" className="img-fluid d-flex d-md-none ms-auto" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="mt-4 swiper1">
                                    <Swiper
                                    ...
                                    >
                                        <SwiperSlide>
                                            <div className="promo-box d-flex">
                                                <div className="w-100">
                                                    <span className="badge dark bg-white text-black mb-2 rounded-pill px-2 py-1">Promo</span>
                                                    <h5>$10m Christmas Race</h5>
                                                    <p className="text-white-70 mb-1">Join Our Christmas race for a share of 10m.</p>
                                                    <p className><a href="#" className="link">Read More</a></p>
                                                    <button className="btn btn1">Race Now</button>
                                                </div>
                                                <div className="ms-3 align-self-end">
                                                    <img src={`${process.env.PUBLIC_URL}/images/promo1.png`} alt="" className="img-fluid img1" />
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="promo-box d-flex">
                                                <div className="w-100">
                                                    ...
                                                    <p className="text-white-70 mb-1">Refer a friend an earn. </p>
                                                    <p className><Link to="referral-program" className="link">Read More</Link></p>
                                                    <button className="btn btn1">Race Now</button>
                                                </div>
                                                <div className="ms-3 align-self-end">
                                        ...
                                        <SwiperSlide>
                                            <div className="promo-box d-flex">
                                                <div className="w-100">
                                                    <span className="badge dark bg-white text-black mb-2 rounded-pill px-2 py-1">Promo</span>
                                                    <h5>Double Winnings</h5>
                                                    <p className="text-white-70 mb-1">Athletic Bilbao Vs. Atletico Madrid &amp; Inter Milan vs.</p>
                                                    <p className><a href="#" className="link">Read More</a></p>
                                                    <button className="btn btn1">Race Now</button>
                                                </div>
                                                <div className="ms-3 align-self-end">
                                                    <img src={`${process.env.PUBLIC_URL}/images/promo3.png`} alt="" className="img-fluid img1" />
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                    </Swiper>
